...
const SecHeader = ({ label, icon, isOpen, onToggle }) => (
  ...
  >
    <div className="flex items-center gap-3">
      ...
      <span className={`text-[10px] font-semibold tracking-[0.15em] uppercase transition-colors ${isOpen ? 'text-slate-900' : 'text-slate-400'}`}>{label}</span>
    </div>
    <HiOutlineChevronDown className={`text-slate-300 text-sm transition-transform duration-300 ${isOpen ? 'rotate-180 text-indigo-600' : ''}`} />
  </button>
);
...
const MeshProperties = ({
  ...
  if (!state) return <div className="p-10 text-center text-slate-400 font-semibold uppercase tracking-widest text-[10px]">Select a part to edit</div>;
        ...
        <div className="p-5 bg-white/30 border-b border-white/40">
          ...
          {selectedPattern && (
            <div className="mt-6 p-4 bg-slate-50 rounded-xl border border-slate-100 space-y-6 text-left">
              ...
              {/* Pattern Tint Color */}
              <div>
                <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-3">Pattern Tint Color</p>
              ...
              <div className="space-y-4 pt-4 border-t border-slate-100">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-[10px] font-semibold text-indigo-600">{((selectedPattern.decalScale || 0.8) * 100).toFixed(0)}%</span>
                  </div>
                  <input
                    type="range"
                    min="0.03"
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-[10px] font-semibold text-indigo-600">{((selectedPattern.decalScaleX !== undefined ? selectedPattern.decalScaleX : (selectedPattern.decalScale || 0.8)) * 100).toFixed(0)}%</span>
                  </div>
                  <input
                    type="range"
                    min="0.03"
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-[10px] font-semibold text-indigo-600">{((selectedPattern.decalScaleY !== undefined ? selectedPattern.decalScaleY : (selectedPattern.decalScale || 0.8)) * 100).toFixed(0)}%</span>
                  </div>
                  <input
                    type="range"
                    min="0.03"
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-3">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-[8px] font-semibold text-slate-400 uppercase tracking-wider">Fade Top</span>
                      <span className="text-[8.5px] font-semibold text-indigo-600">{Math.round((selectedPattern.pFadeTop || 0.0) * 100)}%</span>
                    </div>
                    <input
                      type="range"
                      min="0.0"
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-[8px] font-semibold text-slate-400 uppercase tracking-wider">Fade Bottom</span>
                      <span className="text-[8.5px] font-semibold text-indigo-600">{Math.round((selectedPattern.pFadeBottom || 0.0) * 100)}%</span>
                    </div>
                    <input
                      type="range"
                      min="0.0"
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-[8px] font-semibold text-slate-400 uppercase tracking-wider">Fade Left</span>
                      <span className="text-[8.5px] font-semibold text-indigo-600">{Math.round((selectedPattern.pFadeLeft || 0.0) * 100)}%</span>
                    </div>
                    <input
                      type="range"
                      min="0.0"
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-[8px] font-semibold text-slate-400 uppercase tracking-wider">Fade Right</span>
                      <span className="text-[8.5px] font-semibold text-indigo-600">{Math.round((selectedPattern.pFadeRight || 0.0) * 100)}%</span>
                    </div>
                    <input
                      type="range"
                      min="0.0"
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-[8px] font-semibold text-slate-400 uppercase tracking-wider">Top Left</span>
                      <span className="text-[8.5px] font-semibold text-indigo-600">{Math.round((selectedPattern.pFadeTopLeft || 0.0) * 100)}%</span>
                    </div>
                    <input
                      type="range"
                      min="0.0"
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-[8px] font-semibold text-slate-400 uppercase tracking-wider">Top Right</span>
                      <span className="text-[8.5px] font-semibold text-indigo-600">{Math.round((selectedPattern.pFadeTopRight || 0.0) * 100)}%</span>
                    </div>
                    <input
                      type="range"
                      min="0.0"
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-[8px] font-semibold text-slate-400 uppercase tracking-wider">Bottom Left</span>
                      <span className="text-[8.5px] font-semibold text-indigo-600">{Math.round((selectedPattern.pFadeBottomLeft || 0.0) * 100)}%</span>
                    </div>
                    <input
                      type="range"
                      min="0.0"
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-[8px] font-semibold text-slate-400 uppercase tracking-wider">Bottom Right</span>
                      <span className="text-[8.5px] font-semibold text-indigo-600">{Math.round((selectedPattern.pFadeBottomRight || 0.0) * 100)}%</span>
                    </div>
                    <input
                      type="range"
                      min="0.0"
              ...
              <div className="space-y-4 pt-4 border-t border-slate-100">
                <div className="flex items-center justify-between mb-3">
                  <p className="text-[9px] font-semibold text-slate-400 uppercase tracking-widest">Rotation</p>
                  <span className="text-[10px] font-semibold text-indigo-600">{Math.round((selectedPattern.rotation || 0) * 180 / Math.PI)}°</span>
                </div>
                <input
                  type="range"
                  min="-180"
  ...
  const renderSection = (id, label, content) => {
    ...
    return (
      <div key={id} className={`bg-transparent border-b border-slate-100 ${isLocked ? 'opacity-40 pointer-events-none' : ''}`}>
        ...
        >
          <span className={`text-[10px] font-semibold uppercase tracking-widest ${isOpen ? 'text-indigo-600' : 'text-slate-300'}`}>{label}</span>
          ...
          {textDecals.map((d, i) => (
            ...
            >
              <div className="flex flex-col">
                <span className={`text-[10px] font-semibold tracking-widest ${selectedDecalId === d.id ? 'text-slate-900' : 'text-slate-400'}`}>{d.text || 'EMPTY'}</span>
      ...
      <div className="flex-1">
        {renderSection('font', 'Font & Color', (
          <div className="space-y-6">
            <div>
              <p className="text-[9px] font-semibold text-slate-400 uppercase mb-3">Primary Color</p>
              {renderColorGrid('color')}
            </div>
            <div>
              <p className="text-[9px] font-semibold text-slate-400 uppercase mb-3">Sports Typography</p>
        ...
        {renderSection('transform', 'Layer Size & Rotation', (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                <div className="flex items-center justify-between mb-3">
                  <p className="text-[9px] font-semibold text-slate-400 uppercase tracking-widest">Overall Scale</p>
                  <span className="text-[10px] font-semibold text-indigo-600">{((selected?.decalScale || 0.15) * 100).toFixed(0)}%</span>
                </div>
                <input
                  type="range"
                  min="0.03"
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <p className="text-[9px] font-semibold text-slate-400 uppercase tracking-widest">Width (Horizontal Stretch)</p>
                  <span className="text-[10px] font-semibold text-indigo-600">{((selected?.decalScaleX !== undefined ? selected.decalScaleX : (selected?.decalScale || 0.15)) * 100).toFixed(0)}%</span>
                </div>
                <input
                  type="range"
                  min="0.03"
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <p className="text-[9px] font-semibold text-slate-400 uppercase tracking-widest">Height (Vertical Stretch)</p>
                  <span className="text-[10px] font-semibold text-indigo-600">{((selected?.decalScaleY !== undefined ? selected.decalScaleY : (selected?.decalScale || 0.15)) * 100).toFixed(0)}%</span>
                </div>
                <input
                  type="range"
                  min="0.03"
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <p className="text-[9px] font-semibold text-slate-400 uppercase tracking-widest">Rotation</p>
                  <span className="text-[10px] font-semibold text-indigo-600">{Math.round((selected?.rotation || 0) * 180 / Math.PI)}°</span>
                </div>
                <input
                  type="range"
                  min="-180"
      ...
      <div className="p-6 bg-white/30 border-b border-white/40">
        ...
        <label className="group relative flex flex-col items-center justify-center py-10 border border-dashed border-slate-100 rounded-xl bg-slate-50/30 hover:bg-indigo-50/30 hover:border-indigo-600 transition-all cursor-pointer overflow-hidden">
          ...
          <div className="text-center relative z-10">
            <p className="text-[10px] font-semibold text-slate-900 uppercase tracking-widest">Upload Custom Artwork</p>
            <p className="text-[8px] text-slate-400 uppercase tracking-widest mt-1">PNG, SVG, JPG (Max 5MB)</p>
          </div>
            ...
            <div className="mt-6 p-4 bg-slate-50 rounded-xl border border-slate-100 space-y-6 text-left">
              ...
              <div className="space-y-4 pt-4 border-t border-slate-100">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[9px] font-semibold text-slate-400 uppercase tracking-wider">Overall Scale (Uniform)</span>
                    <span className="text-[10px] font-semibold text-indigo-600">{((selected.decalScale || 0.12) * 100).toFixed(0)}%</span>
                  </div>
                  <input
                    type="range"
                    min="0.03"
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[9px] font-semibold text-slate-400 uppercase tracking-wider">Width (Horizontal Stretch)</span>
                    <span className="text-[10px] font-semibold text-indigo-600">{((selected.decalScaleX !== undefined ? selected.decalScaleX : (selected.decalScale || 0.12)) * 100).toFixed(0)}%</span>
                  </div>
                  <input
                    type="range"
                    min="0.03"
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[9px] font-semibold text-slate-400 uppercase tracking-wider">Height (Vertical Stretch)</span>
                    <span className="text-[10px] font-semibold text-indigo-600">{((selected.decalScaleY !== undefined ? selected.decalScaleY : (selected.decalScale || 0.12)) * 100).toFixed(0)}%</span>
                  </div>
                  <input
                    type="range"
                    min="0.03"
      ...
      <div className="flex-1">
        {logoCategories.map((cat, i) => (
          <div key={cat.name} className="border-b border-slate-50 bg-transparent">
            ...
            >
              <div className="flex items-center gap-3">
                <span className={`text-lg transition-colors ${expandedCat === i ? 'text-indigo-600' : 'text-slate-400'}`}>{cat.icon}</span>
                <span className={`text-[10px] font-semibold uppercase tracking-widest ${expandedCat === i ? 'text-slate-900' : 'text-slate-400'}`}>{cat.name}</span>
              </div>
  ...
  const renderSection = (id, label, icon, content) => {
    ...
    return (
      <div className="bg-white/30 border-b border-white/40">
        ...
        >
          <div className="flex items-center gap-3">
            <span className={`text-lg transition-colors ${isOpen ? 'text-indigo-600' : 'text-slate-400'}`}>{icon}</span>
            <span className={`text-[10px] font-semibold uppercase tracking-widest ${isOpen ? 'text-slate-900' : 'text-slate-400'}`}>{label}</span>
          </div>
          <span className={`text-[10px] transition-transform duration-300 ${isOpen ? 'rotate-45 text-indigo-600' : 'text-slate-300'}`}>＋</span>
        </button>
    ...
    <div className="flex flex-1 md:flex-none w-full md:w-[420px] h-[calc(100%-2rem)] my-4 mr-4 flex-shrink-0 rounded-3xl border border-white/40 bg-transparent/70 backdrop-blur-3xl shadow-[0_8px_32px_rgba(31,38,135,0.07)] flex-col z-50 relative overflow-hidden min-h-0">
      ...
      <div className="px-4 py-2 bg-slate-50 border-t border-slate-100 flex items-center justify-between flex-shrink-0">
        <div className="flex items-center gap-2">
          <div className="w-1.5 h-1.5 rounded-full bg-[#00ff66]/100 animate-pulse shadow-[0_0_8px_rgba(34,197,94,0.5)]" />
          <span className="text-[8px] font-semibold text-slate-400 uppercase tracking-widest">Workspace Connected</span>
        </div>
      </div>
    </div>
  );
